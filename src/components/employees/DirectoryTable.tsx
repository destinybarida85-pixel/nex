  ...
  return (
    <div className="card elev-sm p-[16px_18px] gap-2.5">
      <div className="flex items-center gap-2.5">
        ...
        <div className="flex items-center gap-2 w-[220px] px-2.5 py-1.5 bg-[var(--color-bg)] border border-[var(--color-divider)] rounded-lg text-[var(--color-neutral-500)] text-xs">
          <IconSearch size={13} />
          Search employees…
        </div>
      </div>
