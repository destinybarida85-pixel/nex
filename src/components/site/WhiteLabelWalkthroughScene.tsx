    ...
    <div className="flex gap-4 h-full p-5">
      ...
      <div className="w-[42%] flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="px-3 py-2 rounded-lg text-[13.5px]" style={{ background: "var(--color-surface)" }}>Atlas Chambers</div>
        </div>
        <div className="flex flex-col gap-1">
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-[13px]" style={{ background: "var(--color-surface)", opacity: hasDoc ? 1 : 0.5, transition: "opacity 0.4s" }}>
        ...
        <div className="flex flex-col gap-1">
          ...
          <div className="flex items-center gap-2 px-3 py-2 rounded-lg text-[13px]" style={{ background: "var(--color-surface)", opacity: hasPrice ? 1 : 0.5, transition: "opacity 0.4s" }}>
        ...
        <div
          className="mt-1 px-3 py-2 rounded-lg text-[13px] font-medium text-center flex items-center justify-center gap-1.5"
