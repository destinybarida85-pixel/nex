          ...
          {loading ? (
            ...
            <>
              ...
              {links.length === 0 && !creating && (
                <div className="text-[13.5px] text-[var(--color-neutral-500)]">No payment links yet.</div>
              )}
                ...
                {links.slice(0, 4).map((l) => (
                  <div key={l.id} className="flex items-center gap-2 p-2.5 rounded-lg" style={{ background: "var(--color-surface)" }}>
                    <div className="flex-1 min-w-0">
                      <div className="text-[13.5px] truncate">{l.title}</div>
              ...
              {creating ? (
                ...
                <button className="btn btn-secondary text-[13.5px]" onClick={() => setCreating(true)}>
                  New payment link
                </button>
              )}
            </>
