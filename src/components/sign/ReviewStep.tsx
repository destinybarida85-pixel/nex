  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="rounded-xl overflow-hidden max-h-[320px] overflow-y-auto">
        <DocumentPaper title={document.title} sections={document.sections} accentColor={accentColor} layout={layout} font={document.font} logoUrl={document.logoUrl} big={false} />
      </div>
