...
export default function EmailTemplate({
  ...
  return (
    <div
      ...
      style={{ width: 560 }}
    >
      <div className="p-4 flex flex-col gap-2 text-[13px]" style={{ background: "var(--color-surface)" }}>
      ...
      <div className="p-10 flex flex-col gap-6" style={{ background: "#f5f5f7", color: "#1a1a1f" }}>
        <div className="flex items-center gap-2.5">
          {logoUrl ? (
            ...
            <span
              className="w-8 h-8 rounded-[8px] grid place-items-center font-semibold text-[14px]"
        ...
        <div className="flex flex-col gap-3.5 text-[14.5px] leading-[1.65]" style={{ color: "#3a3a44" }}>
        ...
        <a
          href={signUrl}
          className="self-start px-6 py-3 rounded-lg font-medium text-[14.5px] no-underline"
          style={{ background: tenantAccent, color: "#fff" }}
        >
          Review &amp; sign document
        </a>

        <p className="m-0 text-[13px]" style={{ color: "#6b6b76" }}>
