...
export const documentTemplates: DocumentTemplate[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Investment & Timeline", text: "Total investment: [Amount]\nEstimated timeline: [N] weeks from kickoff\nPayment schedule: [e.g. 50% on signing, 50% on delivery]" },
  ...
  },
  {
    ...
    sections: [
      { heading: "The Brief", text: "[Restate the problem or opportunity as you understand it.]" },
      { heading: "Approach", text: "[How you'll tackle it, and why this approach fits this client specifically.]" },
      { heading: "Deliverables", text: "Phase 1 — [Name]: [Deliverables] — [Timeline]\nPhase 2 — [Name]: [Deliverables] — [Timeline]\nPhase 3 — [Name]: [Deliverables] — [Timeline]" },
      { heading: "Budget", text: "Phase 1: [Amount]\nPhase 2: [Amount]\nPhase 3: [Amount]\nTotal: [Amount]" },
