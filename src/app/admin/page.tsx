      ...
      <main className="flex-1 min-w-0 p-[22px_26px] flex flex-col gap-[18px]">
        ...
        <div className="card elev-sm p-[16px_18px] gap-2.5">
          <div className="flex items-center gap-2.5">
            ...
            <div className="flex-1" />
            <div className="flex items-center gap-2 w-[240px] px-2.5 py-1.5 bg-[var(--color-bg)] border border-[var(--color-divider)] rounded-lg text-[var(--color-neutral-500)] text-xs">
              <IconSearch size={13} />
              Search tenants…
            </div>
          </div>
